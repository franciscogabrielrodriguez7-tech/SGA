...
-- =========================================================
-- 9. PLANTILLA: Creación de Usuario Administrador Inicial
-- Se recomienda ejecutar esta plantilla una sola vez para crear un usuario admin inicial si no lo hay.
-- =========================================================
...
INSERT INTO usuario (
    ...
    '1234567890',                   -- id_usuario: número de documento
    'admin',
    'Gabriel',
    'Rodríguez',
    'admin@correo.com',
    '3009998877',
    '$2b$12$H74nQZRUhI.2LJ7ErM/FOO20zwkH/SelSurfk3ektcR8FvHdhGAIa',
    'CC',
    TRUE
);