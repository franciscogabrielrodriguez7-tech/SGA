...
class DetalleAlquilerUpdate(BaseModel):
    """
    Solo cantidad y precio son modificables. La base de datos
    (trigger fn_validar_detalle_alquiler) ya rechaza explícitamente el
    cambio de id_producto en una línea existente, así que ese campo no
    se expone aquí.
    """
