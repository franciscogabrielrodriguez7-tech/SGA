-- =========================================================
-- NOTA (Gabriel): el seed original venía con 'hash_pwd_123' como
-- contraseña de todos los empleados (texto plano, no un hash real de
-- bcrypt). Como el proyecto exige login vía JWT + bcrypt, se generó
-- aquí un hash bcrypt real para que el login funcione de inmediato en
-- ambiente de pruebas. Contraseña en texto plano para TODOS los
-- empleados de este seed: Sga2026*
-- =========================================================
...
('Francisco Gabriel', 'Rodriguez Sanabria', '1001234567', '3000000000', 'francisco.admin@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'admin', TRUE, 'CC'),
('Carlos Arturo', 'Gómez Ruiz', '1010203040', '3101234567', 'carlos.facturacion@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'encargado_facturacion', TRUE, 'CC'),
('María Fernanda', 'López Díaz', '1010203041', '3111234567', 'maria.facturacion@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'encargado_facturacion', TRUE, 'CC'),
('Jorge Eliecer', 'Pérez Mora', '1010203042', '3121234567', 'jorge.facturacion@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'encargado_facturacion', TRUE, 'CC'),
('Laura Camila', 'Ramírez Soto', '1010203043', '3131234567', 'laura.facturacion@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'encargado_facturacion', TRUE, 'CC'),
('Andrés Felipe', 'Castro Vargas', '1010203044', '3141234567', 'andres.facturacion@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'encargado_facturacion', TRUE, 'CC'),

-- Encargados Logísticos
('Diana Marcela', 'Rojas Peña', '1020304050', '3151234567', 'diana.logistica@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'encargado_logistico', TRUE, 'CC'),
('Javier Eduardo', 'Silva Cruz', '1020304051', '3161234567', 'javier.logistica@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'encargado_logistico', TRUE, 'CC'),
('Paola Andrea', 'Herrera Gil', '1020304052', '3171234567', 'paola.logistica@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'encargado_logistico', TRUE, 'CC'),
('Miguel Ángel', 'Torres Alba', '1020304053', '3181234567', 'miguel.logistica@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'encargado_logistico', TRUE, 'CC'),
('Luisa Fernanda', 'Guzmán Ríos', '1020304054', '3191234567', 'luisa.logistica@sga.com', '$2b$12$wX15a66pU1B2bqmFvsh9yuBzM9glloJ6xn9Tp8u2112sQ.DbXH9lC', 'encargado_logistico', TRUE, 'CC');
